...
const About = () => {
  return (
    <div className="about-page" style={{ background: "linear-gradient(to bottom, #FFDEE2 0%, white 100%)", minHeight: "100vh" }}>
      <Navigation />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-8">
              <div className="flex items-center mb-6">
                <PawPrint size={40} className="text-[#FF9EB1] mr-4" />
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <Card className="bg-white shadow-md border-none">
                <CardContent className="pt-6">
                  <div className="flex justify-center mb-4">
                    <Heart size={40} className="text-[#FF9EB1]" />
                  </div>
              ...
              <Card className="bg-white shadow-md border-none">
                <CardContent className="pt-6">
                  <div className="flex justify-center mb-4">
                    <Star size={40} className="text-[#FF9EB1]" />
                  </div>
              ...
              <Card className="bg-white shadow-md border-none">
                <CardContent className="pt-6">
                  <div className="flex justify-center mb-4">
                    <PawPrint size={40} className="text-[#FF9EB1]" />
                  </div>
