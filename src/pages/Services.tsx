...
import { Heart, Home, Baby, PawPrint, DogBowl, CalendarClock, Squirrel } from "lucide-react";
...
const allServices = [
  ...
  {
    icon: <DogBowl className="w-10 h-10 text-primary animate-paw-print" style={{ animationDelay: "0.4s" }} />,
  ...
  {
    icon: <CalendarClock className="w-10 h-10 text-primary animate-paw-print" style={{ animationDelay: "0.5s" }} />,
  ...
  {
    icon: <Squirrel className="w-10 h-10 text-primary animate-paw-print" style={{ animationDelay: "0.7s" }} />,
    ...
    <>
      ...
      <div className="container px-4 mx-auto py-20">
        ...
        <div className="max-w-xl mx-auto mt-16 text-center">
          ...
          <a 
            href="/#contact" 
            className="inline-flex items-center px-6 py-3 rounded-full bg-[#FFA885] text-white font-medium hover:bg-[#FF9775] transition-colors shadow-md hover:shadow-lg"
          >
            Get in Touch
          </a>
        </div>
